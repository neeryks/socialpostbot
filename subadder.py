...
if __name__ == "__main__":
    sub = SubtitlesClip("subtitles.srt", lambda t: TextClip(t, font="Georgia-Bold", fontsize=24, color="white", stroke_color="black", stroke_width=0.5, encoding='utf-8'))
    myvid = VideoFileClip("atate.mp4")
    comp = CompositeVideoClip([myvid, sub.set_pos(('center','center'))])
    comp.write_videofile("subtitles.mp4", fps=myvid.fps)
